...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    ...
    attrsDict[NSFontAttributeName] = label.font;
    CGSize labelSize = [label.text sizeWithAttributes:attrsDict];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    NSMutableDictionary *detailLabelAttrsDict = [NSMutableDictionary dictionary];
    detailLabelAttrsDict[NSFontAttributeName] = detailsLabel.font;
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading attributes:detailLabelAttrsDict context:nil].size;
